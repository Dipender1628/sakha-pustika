...
export function SubhashitaSection() {
  const subhashitas = [
    ...
    },
    {
      ...
      meaning:
        "शूरवीर उसे ही जानना चाहिए जो दीन-दुखियों के लिए लड़े, जो शरीर के टुकड़े-टुकड़े हो जाने पर भी रणभूमि न छोड़े। यह पंक्ति एक पंजाबी कहावत है जो वीर योद्धा के साहस और बलिदान की भावना को दर्शाती है। इसका अर्थ है कि सच्चा शूरवीर वही है, जो दूसरों की रक्षा के लिए, विशेषकर गरीबों और जरूरतमंदों के लिए, अपने प्राणों की परवाह किए बिना युद्ध करता है और कभी भी हार नहीं मानता।",
    },
  ]
